...
SIGNAL \add_instance|y_present.init~regout\ : std_logic;
...
\add_instance|y_present.init\ : maxv_lcell
-- Equation(s):
-- \add_instance|y_present.init~regout\ = DFFEAS((!\add_instance|outp~0_combout\ & (!\input_vector~combout\(1) & ((\add_instance|Equal0~0_combout\) # (\add_instance|y_present.init~regout\)))), GLOBAL(\input_vector~combout\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datab => \add_instance|y_present.init~regout\,
	datac => \add_instance|outp~0_combout\,
	datad => \input_vector~combout\(1),
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \add_instance|y_present.init~regout\);

-- Location: LC_X16_Y4_N8
\add_instance|y_present~14\ : maxv_lcell
-- Equation(s):
-- \add_instance|y_present~14_combout\ = ((!\input_vector~combout\(1) & (!\add_instance|y_present.init~regout\)))
...
PORT MAP (
	...
	datac => \add_instance|y_present.init~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
